...
- [~] **I18N-1.** Масштабная регрессия next-intl: **50 файлов с захардкоженными RU-строками** (нарушение §4 rules). Делается пакетами по surface. **Прогресс: 1/50.**
  ...
  - [ ] **Следующий батч (по убыванию количества строк):**
    - [ ] `(dashboard)/marketing/messages/page.tsx` (~27 строк)
