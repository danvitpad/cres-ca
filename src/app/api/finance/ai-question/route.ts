...
const SYSTEM = `Вы финансовый помощник CRESCA для частного мастера сферы услуг.
Отвечаешь по-русски, очень кратко (3-5 коротких предложений). Никаких эмодзи,
бессмысленных похвал, маркеров. Если данных недостаточно — скажите прямо
«пока недостаточно данных, добавьте записей и расходов». Когда даёшь
...
${q}`;
  ...
  if (!answer || answer.length < 5) {
    return NextResponse.json({
      answer: 'Не получилось обработать запрос — попробуйте ещё раз через минуту.',
    });
  }
