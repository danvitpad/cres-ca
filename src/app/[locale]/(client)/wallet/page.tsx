      ...
      <Tabs defaultValue="balance" className="w-full">
        ...
        <TabsContent value="balance" className="mt-6 space-y-6">
          ...
          {familyBudget.length > 0 && (
            <div className="rounded-3xl border bg-gradient-to-br from-[var(--color-accent-soft)] via-card to-card p-6 shadow-[var(--shadow-card)]">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="flex size-12 items-center justify-center rounded-2xl bg-[var(--color-accent-soft)] text-[var(--color-accent)] dark:text-[var(--color-accent-text)]">
                ...
                {familyBudget.map((row, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="shrink-0 rounded-full bg-[var(--color-accent-soft)] px-2.5 py-0.5 text-[11px] font-semibold text-[var(--color-accent)] dark:text-[var(--color-accent-text)]">
                    ...
                    {familyTotal > 0 && (
                      <div className="mt-3 h-1.5 overflow-hidden rounded-full bg-muted">
                        <motion.div
                          ...
                          className="h-full rounded-full bg-gradient-to-r from-[var(--color-accent)] to-emerald-500"
                        />
                      </div>
                    )}
                  </li>
