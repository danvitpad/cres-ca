      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24, gap: 16 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 6, flex: 1 }}>
          ...
          <HelpHint title="Как работают промокоды" size={16}>
            <p><b>Что это:</b> вы выпускаешь код вроде «NEW2026» со скидкой (например, -20%). Клиент при записи вводит этот код — цена услуги падает.</p>
            <p><b>Кто видит:</b> промокод видите только вы в этом разделе. Клиент узнаёт код от вас — через сообщение, рассылку, инстаграм. Деньги клиент платит уже со скидкой.</p>
            <p><b>Что в финансах:</b> в записи остаётся пометка какой промокод применён и сколько ₴ скидки. В отчёте «Доход» сумма уже за вычетом скидки — то есть это ваш реальный заработок.</p>
            <p><b>Защита от убытков:</b> если вы заполнил расходники в услугах, при создании промокода появится подсказка «Эта скидка сделает услугу убыточной» — это не блок, вы сам решаешь (например, для привлечения новых клиентов это нормально).</p>
                    ...
                    <p style={{ fontSize: 12, color: C.textSecondary, margin: 0, lineHeight: 1.5 }}>
                      {simSummary.unsafe_services > 0 ? (
                        <>
                          ...
                          {' '}Это ваш выбор — можно сохранить (например, чтобы привлечь новых клиентов), но имей в виду.
