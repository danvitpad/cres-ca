...
const TL = {
  toolbarBg: '#ffffff',
  toolbarBorder: 'rgba(13,148,136,0.07)',
  btnBorder: 'rgba(13,148,136,0.13)',
  btnBg: '#ffffff',
  btnHoverBg: '#fafafa',
  btnActiveBg: '#f4f4f5',
  btnText: '#0a0a0a',
  addBg: 'var(--color-accent)',
  addText: '#ffffff',
  addBorder: 'var(--color-accent)',
  popoverBg: '#ffffff',
  popoverBorder: 'rgba(13,148,136,0.13)',
  popoverShadow: 'rgba(13,148,136,0.06) 0px 2px 8px 0px, rgba(13,148,136,0.10) 0px 4px 20px 0px',
  popoverItemActiveBg: 'rgba(13,148,136,0.08)',
  popoverItemHoverBg: '#fafafa',
...
const TD = {
  toolbarBg: '#1a1a1d',
  toolbarBorder: 'rgba(45,212,191,0.08)',
  btnBorder: 'rgba(45,212,191,0.16)',
  btnBg: '#1a1a1d',
  btnHoverBg: '#151830',
  btnActiveBg: '#1f1f22',
  btnText: '#fafafa',
