...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    ...
    noShowHint: 'Спробуйте вимагати передплату для нових клієнтів',
    ...
    clientLabel: 'Клієнт (опційно)', clientPh: 'Почніть друкувати імʼя',
    serviceLabel: 'Послуга (опційно)', servicePh: 'Почніть друкувати назву',
    ...
    errInvalidAmount: 'Введіть коректну суму', errNoInitData: 'Немає initData', errGeneric: 'Помилка',
  },
  ru: {
    ...
    noShowHint: 'Попробуйте требовать предоплату для новых клиентов',
    topServices: 'Топ-услуги', noData: 'Ещё нет данных',
    noDataHint: 'Начните принимать клиентов — статистика появится автоматически',
    ...
    clientLabel: 'Клиент (опционально)', clientPh: 'Начните печатать имя',
    serviceLabel: 'Услуга (опционально)', servicePh: 'Начните печатать название',
    ...
    errInvalidAmount: 'Введите корректную сумму', errNoInitData: 'Нет initData', errGeneric: 'Ошибка',
  },
  en: {
