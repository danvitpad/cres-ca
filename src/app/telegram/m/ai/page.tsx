 ...
 *              с подсказками-плитками (запишите расход, выручка за неделю,
...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    ...
    errReply: 'Не вдалось відповісти зараз, спробуйте ще раз через хвилину.',
    errNetwork: 'Помилка мережі. Перевірте інтернет та повтори.',
    suggestionsTitle: 'Спробуйте',
    s1: 'Запишите витрату 500₴ на матеріали',
    s2: 'Запишите Аню на завтра о 14:00 на манікюр',
  ...
  ru: {
    ...
    errReply: 'Не получилось ответить сейчас, попробуйте ещё раз через минуту.',
    errNetwork: 'Ошибка сети. Проверьте интернет и повтори.',
    suggestionsTitle: 'Попробуйте',
    s1: 'Запишите расход 500₴ на материалы',
    s2: 'Запишите Аню на завтра в 14:00 на маникюр',
