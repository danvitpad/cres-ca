...
import { Search, AlertTriangle, Star, Crown, Loader2, UserPlus } from 'lucide-react';
...
import { ContactSearchSheet } from '@/components/miniapp/contact-search-sheet';
  ...
  return (
    <MobilePage>
      ...
      <div style={{ padding: `12px ${PAGE_PADDING_X}px 0` }}>
        ...
        >
          <UserPlus size={16} /> Добавить контакт
        </button>
      </div>
      ...
      {addOpen && (
        <ContactSearchSheet
          ...
          onClose={() => { setAddOpen(false); setReloadKey((k) => k + 1); }}
        />
      )}
    </MobilePage>
  );
