...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    ...
    empty: 'Склад порожній', emptyHint: 'Додайте перший матеріал — тапните «+ Додати»',
    ...
    suppliersEmptyHint: 'Спочатку додайте постачальника у вкладці «Постачальники» — тоді при формуванні замовлення сюди потраплять тільки його товари',
    thresholdHint: 'Коли залишок впаде нижче — отримаєте push',
    placeholderName: 'Гель, олія, голка…',
    save: 'Зберегти', saving: 'Зберігаємо…',
    deleteBtn: 'Видалити', deleteConfirm: 'Видалити повністю?',
    errName: 'Введите назву', errQuantity: 'Введите залишок', errSave: 'Не вдалось зберегти',
  ...
  ru: {
    ...
    empty: 'Склад пустой', emptyHint: 'Добавьте первый материал — тапните «+ Добавить»',
    ...
    suppliersEmptyHint: 'Сначала добавьте поставщика во вкладке «Поставщики» — тогда при формировании заказа сюда попадут только его товары',
    thresholdHint: 'Когда остаток опустится ниже — получите push',
    placeholderName: 'Гель, масло, иголка…',
    save: 'Сохранить', saving: 'Сохраняем…',
    deleteBtn: 'Удалить', deleteConfirm: 'Удалить полностью?',
    errName: 'Введите название', errQuantity: 'Введите остаток', errSave: 'Не удалось сохранить',
