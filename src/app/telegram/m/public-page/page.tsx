...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    ...
    bio: 'Про себе', bioEmpty: 'Тапните ✎ щоб додати опис', bioEdit: 'Про себе',
    interests: 'Інтереси', interestsEmpty: 'Тапните ✎ щоб додати інтереси',
    interestsHint: 'Що любиш окрім роботи — спорт, кава, подорожі. До 10 тегів.',
    interestsAdd: 'Додати', interestsPh: 'Введите та натисни ↵',
    name: 'Імʼя', nameEdit: 'Імʼя та прізвище', nameFirst: 'Імʼя', nameLast: 'Прізвище',
    specialization: 'Спеціалізація', specEmpty: 'Тапните ✎ щоб задати', specEdit: 'Спеціалізація',
    ...
    address: 'Адреса', addressEmpty: 'Тапните ✎ щоб додати', addressEdit: 'Адреса',
  ...
  ru: {
    ...
    reviews: (n) => `${n} отзывов`,
    bio: 'О себе', bioEmpty: 'Тапните ✎ чтобы добавить описание', bioEdit: 'О себе',
    interests: 'Интересы', interestsEmpty: 'Тапните ✎ чтобы добавить интересы',
    interestsHint: 'Что любишь кроме работы — спорт, кофе, путешествия. До 10 тегов.',
    interestsAdd: 'Добавить', interestsPh: 'Введите и нажми ↵',
    name: 'Имя', nameEdit: 'Имя и фамилия', nameFirst: 'Имя', nameLast: 'Фамилия',
    specialization: 'Специализация', specEmpty: 'Тапните ✎ чтобы задать', specEdit: 'Специализация',
    ...
    address: 'Адрес', addressEmpty: 'Тапните ✎ чтобы добавить', addressEdit: 'Адрес',
