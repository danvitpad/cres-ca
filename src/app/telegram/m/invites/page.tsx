...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    title: 'Запрошення',
    awaiting: (n) => `Чекають вашої відповіді: ${n}`,
    emptySubtitle: 'Тут зʼявляться запрошення від адміністраторів салонів',
    emptyTitle: 'Немає запрошень',
    emptyDesc: 'Коли адмін салону покличе вам в команду — запрошення зʼявиться тут.',
  ...
  ru: {
    title: 'Приглашения',
    awaiting: (n) => `Ждут вашего ответа: ${n}`,
    emptySubtitle: 'Здесь появятся приглашения от админов салонов',
    emptyTitle: 'Нет приглашений',
    emptyDesc: 'Когда админ салона позовёт вас в команду, приглашение появится здесь.',
