...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-dvh bg-white text-neutral-900">
      <header className="sticky top-0 z-10 flex items-center gap-3 border-b border-neutral-200 bg-white/95 px-4 py-3 backdrop-blur-xl">
        <button
          onClick={() => router.back()}
      ...
      <main className="space-y-6 px-6 py-8 text-[13px] leading-relaxed text-neutral-800">
        <section className="space-y-2">
          <h2 className="text-[15px] font-semibold text-neutral-900">1. Что такое CRES-CA</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-[15px] font-semibold text-neutral-900">2. Какие данные мы сохраняем</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-[15px] font-semibold text-neutral-900">3. Кому видны ваши данные</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-[15px] font-semibold text-neutral-900">4. Ваши права</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-[15px] font-semibold text-neutral-900">5. Связь с нами</h2>
          <p>
        ...
        <p className="pt-4 text-[11px] text-neutral-400">
