 ...
 *              агрегированный экран «у тебя X баллов всего» — не делаем.
...
const I18N: Record<MiniAppLang, { title: string; body: string; backHome: string }> = {
  uk: {
    ...
    body: 'Ми готуємо нову програму лояльності. Бонуси за візити вже накопичуються у твоїх майстрів — їх можна буде застосувати в наступних релізах.',
    backHome: 'На головну',
  },
  ru: {
    title: 'Бонусная программа скоро',
    body: 'Готовим новую программу лояльности. Бонусы за визиты уже копятся у твоих мастеров — применить их можно будет в ближайших релизах.',
    backHome: 'На главную',
  },
  en: {
