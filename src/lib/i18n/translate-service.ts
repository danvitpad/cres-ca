...
const SYSTEM = `Вы переводчик названий услуг мастеров (бьюти, спорт, образование, авто, дом и т.д.).
Вам дано название и описание на одном из трёх языков (uk / ru / en).
