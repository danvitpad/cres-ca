...
const SYSTEM_PROMPT = `Ты — голосовой AI-ассистент клиента в CRM CRES-CA. Клиент шлёт голосовое в Telegram-бот.
...
- "записать", "запиши меня", "хочу записаться" → book
...
- "не работает", "плохо", "идея", "хочу чтобы", "благодарю", "спасибо", "вопрос" → feedback
...
Аудио: «Запиши меня к Анне на стрижку завтра в два»
→ {"action":"book","raw_transcript":"Запиши меня к Анне на стрижку завтра в два","confidence":0.95,"master_hint":"Анна","service_hint":"стрижка","starts_at":"<завтра>T14:00:00+03:00","period":null}
...
function normalizeIntent(raw: RawIntent): ClientVoiceIntent {
  const allowedActions: ClientVoiceAction[] = ['feedback', 'book', 'cancel', 'reschedule', 'list_appointments', 'spending', 'unknown'];
