...
const SYSTEM_PROMPT = `Вы — AI-ассистент мастера beauty/service индустрии. Мастер отправляет голосовое сообщение или текст.
...
- "client_update" — обновить КОНКРЕТНОЕ поле клиента. Используй когда мастер прямо говорит "добавьте/укажите/поменяй [поле] у клиента". Поля (field):
...
- "вечером" = 18:00
- Если время не указано, дата есть — ставьте 09:00
