...
export function InlineBioBlock({ masterId, masterProfileId, initialBio }: Props) {
  ...
  return (
    <section id="bio">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-[22px] font-bold text-neutral-900">О мастере</h2>
        {isOwner && (
          <button
            type="button"
            onClick={startEdit}
  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={6}
        autoFocus
        placeholder="Например: «Работаю 7 лет с акцентом на здоровый маникюр. Использую только премиальные материалы. Каждый клиент уходит с улыбкой.»"
