    ...
    >
      ...
      <div className="text-center">
        ...
        {salonContext && teamLabel && (
          <div className="mx-auto mb-2 inline-flex items-center gap-1.5 rounded-[var(--brand-radius-lg)] bg-[#2563eb] px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-white">
