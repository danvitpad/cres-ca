          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 14, marginBottom: 4 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <HelpHint title="Как работает реферальная программа" size={15}>
                <p><b>Идея:</b> постоянный клиент рекомендует вас другу — друг записывается — клиент получает бонус.</p>
                ...
                <p><b>Что значит для вас:</b> вы привлекаешь клиентов руками других клиентов вместо рекламы. Бонус выпадает только после фактического выполненного визита — без визита приглашатель ничего не получит, защита от накруток.</p>
                <p><b>Что в финансах:</b> бонус приглашателя выпадает в его счёт лояльности, не в кэш. То есть он сможет потратить его только на следующую запись у вас — деньги остаются в твоём круге.</p>
        ...
        {!slug ? (
          <div style={{
            ...
            <p style={{ fontSize: 13, color: C.text, lineHeight: 1.5, margin: 0, flex: 1 }}>
              Чтобы получить ссылку — задай публичный адрес мастера. Сгенерируем из вашего имени.
            </p>
            <button
              type="button"
