...
const TOUR_STEPS: TourStep[] = [
  {
    key: 'today',
    path: 'today',
    title: 'Сегодня — твой утренний экран',
    intro:
      'Открыл кабинет — сразу видишь главное. Ничего искать не нужно: все важные подсказки на сегодня собраны на одной странице.',
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Клик на пустое время → быстрая запись со всеми твоими услугами',
    ],
  },
  {
    key: 'finance',
