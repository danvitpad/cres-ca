...
const LIGHT = {
  ...
  cellBg: '#ffffff',
  cellHover: '#f8f6fd',
  cellBorder: 'rgba(124,58,237,0.08)',
  otherMonthBg: '#f8f6fd',
  ...
  todayText: '#ffffff',
  accent: '#7c3aed',
  dotColors: ['#7c3aed', '#06b6d4', '#f59e0b', '#10b981', '#ef4444', '#ec4899'],
  weekendBg: '#f8f6fd',
};
...
const DARK = {
  ...
  cellBg: '#0b0d17',
  cellHover: '#151830',
  cellBorder: 'rgba(139,92,246,0.08)',
  otherMonthBg: '#0e1020',
  ...
  todayText: '#ffffff',
  accent: '#8b5cf6',
  dotColors: ['#8b5cf6', '#67e8f9', '#fbbf24', '#34d399', '#f87171', '#f472b6'],
  weekendBg: '#0f1120',
};
