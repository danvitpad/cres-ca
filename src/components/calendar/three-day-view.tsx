...
const LIGHT = {
  ...
  timeText: '#64607a',
  currentTime: '#ef4444',
  todayBg: 'rgba(37, 99, 235,0.04)',
  headerBg: '#ffffff',
  headerBorder: 'rgba(37, 99, 235,0.08)',
  headerShadow: 'rgba(37, 99, 235,0.06) 0px 2px 4px 0px',
...
const DARK = {
  ...
  timeText: '#a1a1aa',
  currentTime: '#f87171',
  todayBg: 'rgba(96, 165, 250,0.1)',
  headerBg: '#1a1a1d',
  headerBorder: 'rgba(96, 165, 250,0.1)',
