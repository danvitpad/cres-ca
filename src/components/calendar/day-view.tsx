...
const LIGHT = {
  pageBg: '#ffffff',
  nonWorkingBg: '#fafafa',
  gridBorder: 'rgba(13,148,136,0.08)',
  gridBorderSub: 'rgba(13,148,136,0.04)',
  text: '#0a0a0a',
  timeText: '#64607a',
  ...
  avatarBg: '#f4f4f5',
  avatarBorder: 'rgba(13,148,136,0.13)',
  avatarText: '#0a0a0a',
  cardBg: 'var(--color-accent-text)',
  cardText: '#0a0a0a',
  headerShadow: 'rgba(13,148,136,0.06) 0px 6px 4px 0px',
  popupBg: '#ffffff',
  popupBorder: 'rgba(13,148,136,0.13)',
  popupShadow: 'rgba(13,148,136,0.06) 0px 2px 8px 0px, rgba(13,148,136,0.10) 0px 4px 20px 0px',
  textMuted: '#64607a',
  accent: 'var(--color-accent)',
  hoverSlot: 'rgba(13,148,136,0.06)',
  hoverPopupItem: '#fafafa',
  newBlockBg: 'rgba(13,148,136,0.12)',
