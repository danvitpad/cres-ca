...
const LIGHT = {
  pageBg: '#ffffff',
  nonWorkingBg: '#fafafa',
  gridBorder: 'rgba(37, 99, 235,0.08)',
  gridBorderSub: 'rgba(37, 99, 235,0.04)',
  text: '#0a0a0a',
  timeText: '#64607a',
  ...
  avatarBg: '#f4f4f5',
  avatarBorder: 'rgba(37, 99, 235,0.13)',
  avatarText: '#0a0a0a',
  cardBg: 'var(--color-accent-text)',
  cardText: '#0a0a0a',
  headerShadow: 'rgba(37, 99, 235,0.06) 0px 6px 4px 0px',
  popupBg: '#ffffff',
  popupBorder: 'rgba(37, 99, 235,0.13)',
  popupShadow: 'rgba(37, 99, 235,0.06) 0px 2px 8px 0px, rgba(37, 99, 235,0.10) 0px 4px 20px 0px',
  textMuted: '#64607a',
  accent: 'var(--color-accent)',
  hoverSlot: 'rgba(37, 99, 235,0.06)',
  hoverPopupItem: '#fafafa',
  newBlockBg: 'rgba(37, 99, 235,0.12)',
  newBlockBorder: 'var(--color-accent)',
  newBlockTimeText: 'var(--color-accent)',
...
const DARK = {
  pageBg: '#141417',
  nonWorkingBg: '#0e0e10',
  gridBorder: 'rgba(96, 165, 250,0.1)',
  gridBorderSub: 'rgba(96, 165, 250,0.05)',
  text: '#fafafa',
  timeText: '#a1a1aa',
  timeLabelSuffix: '#a1a1aa',
  currentTime: '#f87171',
  currentTimeBg: '#141417',
  avatarBg: '#1f1f22',
  avatarBorder: 'rgba(96, 165, 250,0.16)',
  avatarText: 'var(--color-accent-text)',
  cardBg: '#60a5fa',
  cardText: '#ffffff',
  headerShadow: 'rgba(0, 0, 0, 0.4) 0px 6px 4px 0px',
  popupBg: '#1a1a1d',
  popupBorder: 'rgba(96, 165, 250,0.16)',
  popupShadow: 'rgba(0,0,0,0.4) 0px 2px 8px 0px, rgba(0,0,0,0.5) 0px 4px 20px 0px',
  textMuted: '#a1a1aa',
  accent: '#60a5fa',
  hoverSlot: 'rgba(96, 165, 250,0.12)',
  hoverPopupItem: '#151830',
  newBlockBg: 'rgba(96, 165, 250,0.2)',
  newBlockBorder: '#60a5fa',
  newBlockTimeText: 'var(--color-accent-text)',
