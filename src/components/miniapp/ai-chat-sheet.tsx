...
const I18N: Record<MiniAppLang, {
  ...
  uk: {
    ...
    welcomeBody: 'Запис, перенесення, скасування, витрати, бонуси, ваші майстри — пишите або говори голосом, я зрозумію.',
    prompts: ['Які в мене записи?', 'Скільки я витратила цього місяця?', 'Скільки в мене бонусів?', 'Хто мої майстри?', 'Скасуй мій запис', 'Що ви вмієш?'],
    ...
    replyFailed: 'Не вдалось відповісти', connectionLost: 'Зʼєднання обірвалось. Спробуйте ще раз.',
  ...
  ru: {
    ...
    welcomeBody: 'Запись, перенос, отмена, расходы, бонусы, ваши мастера — пишите или говори голосом, я пойму.',
    prompts: ['Какие у меня записи?', 'Сколько я потратила в этом месяце?', 'Сколько у меня бонусов?', 'Кто мои мастера?', 'Отмени мою запись', 'Что вы умеешь?'],
    ...
    replyFailed: 'Не удалось ответить', connectionLost: 'Соединение прервалось. Попробуйте ещё раз.',
